...
async function runTests() {
  ...
  try {
    ...
    // Check pricing:
    // Sub-order 1 itemsPrice: 200. Shop 1 voucher: 5. Platform proportional discount: 20. Shipping: 10. Tax (15% of 200) = 30.
    // Total price = 200 - (20 + 5) + 10 + 30 = 215.
    if (oShop1.totalPrice !== 215) {
      throw new Error(`Pricing incorrect for Sub-order 1. Expected 215, got ${oShop1.totalPrice}`);
    }
    console.log('Passed Sub-order 1 calculation check.');

    // Sub-order 2 itemsPrice: 200. Platform proportional discount: 20. Shipping: 10. Tax = 30.
    // Total price = 200 - 20 + 10 + 30 = 220.
    if (oShop2.totalPrice !== 220) {
      throw new Error(`Pricing incorrect for Sub-order 2. Expected 220, got ${oShop2.totalPrice}`);
    }
